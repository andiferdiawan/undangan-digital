...
- Kelas motion (opsional): "uv-reveal", "uv-reveal-zoom", "uv-reveal-left", "uv-reveal-right", "uv-reveal-flip", "uv-reveal-mask" (foto tersingkap seperti tirai) = muncul beranimasi saat digulir, tunda dengan "uv-d1".."uv-d5"; "uv-tilt" = kartu 3D mengikuti kemiringan ponsel, anaknya boleh "uv-depth-1".."uv-depth-3" untuk lapisan (jangan beri overflow-hidden pada "uv-tilt"); "uv-float3d"/"uv-spin3d" = ornamen berputar 3D; "uv-shine" = kilau. Jangan gabungkan kelas motion dengan kelas translate/rotate/scale di elemen yang sama.
